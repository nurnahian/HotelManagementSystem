...
public class payment extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        iii2.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        ...
        billtable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ROOM NO.", "NAME", "MOBILE NO.", "STATUS", "CHECK IN", "CHECK OUT", "NET BILL", "PAYMENT"
            }
        ));
        jScrollPane1.setViewportView(billtable);

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel5.setText("Payment Table");

        print.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        print.setText("Prtint And Conformation");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(174, 174, 174)
                        .addComponent(print, javax.swing.GroupLayout.PREFERRED_SIZE, 450, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            while(rs.next()) {
                ...
                model.addRow(new Object[] {no,name,mob,typ,cin,cout,roomp,pay});
            }
            rs.close();
        } catch (Exception e) {
    ...
    private void printActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_printActionPerformed
        // TODO add your handling code here:
          ...
          String iii=bill.getText();
           String no=bill.getText();
     String nam="";
     String mob="";
     ...
     String pay="DUE";
         try
        {
           ...
           Statement smt3=con.createStatement();
                       ...
                       int success=smt3.executeUpdate(query);
                            if(success==1)
                            {
                                JOptionPane.showMessageDialog(this, "The Room is Now AVAILABLE");
    ...
    catch(Exception e)
        {
         ...
         JOptionPane.showMessageDialog(null, "Print A payment receipt");
  billtable.setModel(new DefaultTableModel(null,new Object[]{"ROOM NO.","NAME","MOBILE NO.","STATUS","CHECK IN","CHECK OUT","PAYMENT"}));
